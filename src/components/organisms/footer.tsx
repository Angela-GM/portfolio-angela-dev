export const Footer = () => {
  ...
  const footerLinks = {
    ...
    contacto: [
      { name: "Email", href: "mailto:angelagm0112@gmail.com" },
      {
        name: "LinkedIn",
        href: "https://www.linkedin.com/in/angela-garcia-mu/",
      },
      { name: "GitHub", href: "https://github.com/Angela-GM" },
      { name: "Teléfono", href: "tel:+34696753758" },
    ],
  };
  ...
  return (
    <footer className="bg-gray-900 text-white">
      ...
      <button
        ...
        className="fixed bottom-8 right-8 bg-gradient-to-r from-purple-600 to-violet-600 text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 z-40"
